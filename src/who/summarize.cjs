  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `この人 (日本語での名前は ${nameJa}, 英語では ${nameEn}です。)について日本語を使ってポジティブに、そして簡潔に紹介してください。その人に対して良いイメージを与えるのが目的なため、ネガティブな情報や、詳細な情報、意味がわからない部分は伝えなくて構いません。以下はその人の自己紹介です：${bio}\nまた、この人のタイムラインは以下のように記述されています。(json形式で書かれています): ${text}`,
        },
      ],
      temperature: 0.7,
      max_tokens: 1000,
