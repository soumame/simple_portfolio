...
import { Contact, Briefcase, StickyNote, Share2 } from "lucide-react";
      ...
      <Tooltip.Root delayDuration={0}>
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            ...
            text-gray-700 select-none rounded-2xl bg-gray-white p-4 text-base leading-none shadow-md will-change-[transform,opacity] bg-gray-200"
            sideOffset={5}
          >
            {props.text}
            <Tooltip.Arrow className="backdrop-brightness-125 fill-gray-200 backdrop-blur-sm shadow-md" />
          </Tooltip.Content>
        </Tooltip.Portal>
      </Tooltip.Root>
    </Tooltip.Provider>
