    ...
    <div className="snap-center w-full h-full p-4">
      ...
      <div className="gap-4 md:grid-cols-3 grid-cols-2 grid mt-2 h-[80%]">
        {contacts.map(({ label, link, icon }) => (
          <motion.div
            className="bg-gray-300 rounded-3xl border-gray-200 relative flex justify-center items-center hover:dropshadow-xl shadow-white hover:bg-gray-100 transition duration-500 ease-in-out col-span-auto"
            key={label}
